...
//#define __CM_REV               0x0201U  /* Core Revision r2p1 */
#define __CM_REV __CM7_REV
...
#include "system_qm7.h"                    /* System Header */
...
/* QM7_TMR LOAD Register Definitions */
#define QM7_TMR_LOAD_Pos              0
#define QM7_TMR_LOAD_Msk             (0xFFFFFFFFUL /*<< QM7_TMR_LOAD_Pos*/)

/* QM7_TMR VALUE Register Definitions */
#define QM7_TMR_VALUE_Pos             0
#define QM7_TMR_VALUE_Msk            (0xFFFFFFFFUL /*<< QM7_TMR_VALUE_Pos*/)

/* QM7_TMR CONTROL Register Definitions */
#define QM7_TMR_CONTROL_SIZE_Pos      1
#define QM7_TMR_CONTROL_SIZE_Msk     (1UL << QM7_TMR_CONTROL_SIZE_Pos)

#define QM7_TMR_CONTROL_ONESHOT_Pos   0
#define QM7_TMR_CONTROL_ONESHOT_Msk  (1UL /*<< QM7_TMR_CONTROL_ONESHOT_Pos*/)
...
#define QM7_FLASH_BASE       (0x00000000UL)                              /* (FLASH     ) Base Address */
#define QM7_SRAM_BASE        (0x20000000UL)                              /* (SRAM      ) Base Address */
#define QM7_PERIPH_BASE      (0x40000000UL)                              /* (Peripheral) Base Address */

/* Peripheral memory map */
#define QM7TIM0_BASE         (QM7_PERIPH_BASE)          /* (Timer0    ) Base Address */
#define QM7TIM1_BASE         (QM7_PERIPH_BASE + 0x0800) /* (Timer1    ) Base Address */
#define QM7TIM2_BASE         (QM7_PERIPH_BASE + 0x1000) /* (Timer2    ) Base Address */
...
#define QM7_TIM0        ((QM7_TMR_TypeDef *) QM7TIM0_BASE)
#define QM7_TIM1        ((QM7_TMR_TypeDef *) QM7TIM0_BASE)
#define QM7_TIM2        ((QM7_TMR_TypeDef *) QM7TIM0_BASE)
